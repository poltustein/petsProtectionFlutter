                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child:widget.plans!.plans![index].isActive? MaterialButton(
                                onPressed: (){}, color: Colors.white, child: Padding(
              ...
              Container(
                child: Padding(
                  ...
                  child: MaterialButton(onPressed: (){
                    log("buttone clicked!!="+ widget.selectedPlanIndex.toString());
                    Get.to(widget.selectedPlanIndex >= 0 ? PlanInfoScreen(plan: widget.plans!.plans![widget.selectedPlanIndex], selections: List.filled(widget.plans!.plans![0].planCosts!.length, false)) : null );
