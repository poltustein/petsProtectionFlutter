...
class PlanInfoScreen extends StatefulWidget {
  ...
  PlanInfoScreen({Key? key, required this.plan, required this.selections});
                          ...
                          child: Row(
                            children: [
                              ...
                              Flexible(flex: 4, child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(widget.plan.planCosts![index], style: TextStyle(fontSize: 25.0,color: Colors.white,fontWeight: FontWeight.bold),),
                              ))
                            ],
                          ),
                        ),
              ...
              Padding(
                ...
                child: Container(
                  margin: EdgeInsets.all(15.0),
                    child: MaterialButton(onPressed: (){}, child: Text("Continue", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),), minWidth: double.infinity, color: Colors.yellow[700], height: 60, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(22)),)),
              )
            ],
          ),
        )
